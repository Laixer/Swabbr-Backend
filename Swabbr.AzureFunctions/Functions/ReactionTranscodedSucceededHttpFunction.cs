...
namespace Swabbr.AzureFunctions.Functions
{
    ...
    /// </summary>
    public sealed class ReactionTranscodedSucceededHttpFunction
    {
        ...
        /// </summary>
        public ReactionTranscodedSucceededHttpFunction(IReactionService reactionService)
        {
        ...
        [FunctionName(nameof(ReactionTranscodedSucceededHttpFunction))]
        public async Task<IActionResult> Run([HttpTrigger(AuthorizationLevel.Function, "post", Route = null)] HttpRequest req, ILogger log)
        {
            ...
            // Log and process
            log.LogInformation($"Triggered {nameof(ReactionTranscodedSucceededHttpFunction)} for reaction {reactionId} at { wrapper.EventTime}");
            await _reactionService.OnTranscodingReactionSucceededAsync(reactionId).ConfigureAwait(false);
            log.LogInformation($"Finished {nameof(ReactionTranscodedSucceededHttpFunction)} for reaction {reactionId} at { wrapper.EventTime}");
